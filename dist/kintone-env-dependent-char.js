...
(function () {
  ...
  kintone.events.on("app.record.detail.show", function (event) {
    try {
      ...
      // フィールド名を配列で定義
      var fieldCodes = ['お客様からの修正内容', '備考', '営業所属', '校正回数', '注文商品名', '納期'];
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 10:
            ...
            return getAllRecordsResp.filter(function (record) {
              return nonJISRegex.test(record.お客様からの修正内容.value) || nonJISRegex.test(record.備考.value) || nonJISRegex.test(record.営業所属.value) || nonJISRegex.test(record.校正回数.value) || nonJISRegex.test(record.注文商品名.value) || nonJISRegex.test(record.納期.value);
            });
          case 14:
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkyutaka_production_design_proofreading"] = self["webpackChunkyutaka_production_design_proofreading"] || [];
